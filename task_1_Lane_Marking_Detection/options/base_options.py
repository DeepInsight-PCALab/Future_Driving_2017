...
class BaseOptions(object):
    def __init__(self):
        ...
        self.parser.add_argument('--depth',       type = int, default = 152, help = '# of resnext depth')
        ...
        self.parser.add_argument('--lam_attr',        type = float, default = 0.4,     help = 'loss balance for cls loss')
